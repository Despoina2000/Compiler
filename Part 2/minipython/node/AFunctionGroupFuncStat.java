...
public final class AFunctionGroupFuncStat extends PGroupFuncStat
{
    private PFunction _function_;

    public AFunctionGroupFuncStat()
    {
    }
    ...
    public Object clone()
    {
        return new AFunctionGroupFuncStat(
            (PFunction) cloneNode(_function_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFunctionGroupFuncStat(this);
    }
