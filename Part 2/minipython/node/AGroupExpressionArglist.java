...
public final class AGroupExpressionArglist extends PArglist
{
    ...
    public Object clone()
    {
        return new AGroupExpressionArglist(
    ...
    {
        ((Analysis) sw).caseAGroupExpressionArglist(this);
    }
    ...
    private class GroupCommaExpr_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AGroupExpressionArglist.this))
            {
                node.parent().removeChild(node);
            }
