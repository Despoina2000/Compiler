...
public final class AFunCallExpression extends PExpression
{
    private TId _id_;
    private PFunctionCall _functionCall_;

    public AFunCallExpression()
    {
    }
    ...
    {
        ((Analysis) sw).caseAFunCallExpression(this);
    }
