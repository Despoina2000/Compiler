...
public final class AFunctionCExpression extends PExpression
{
    private PFunctionCall _functionCall_;

    public AFunctionCExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AFunctionCExpression(
            (PFunctionCall) cloneNode(_functionCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFunctionCExpression(this);
    }
