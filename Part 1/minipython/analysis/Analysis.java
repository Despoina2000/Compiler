...
public interface Analysis extends Switch
{
    ...
    void caseAFromInportImportType(AFromInportImportType node);
    ...
    void caseADmultPower(ADmultPower node);
    void caseAPowerMultiplication(APowerMultiplication node);
    void caseAMultMultiplication(AMultMultiplication node);
    void caseADivMultiplication(ADivMultiplication node);
    void caseAPercentMultiplication(APercentMultiplication node);
    void caseAMultiplicationAdditionSubition(AMultiplicationAdditionSubition node);
    void caseAAddAdditionSubition(AAddAdditionSubition node);
    void caseASubAdditionSubition(ASubAdditionSubition node);
    ...
    void caseAPlusMathTypes(APlusMathTypes node);
    void caseAMinusMathTypes(AMinusMathTypes node);
    void caseAMultMathTypes(AMultMathTypes node);
    void caseADivMathTypes(ADivMathTypes node);
    void caseAModMathTypes(AModMathTypes node);
    void caseAPowMathTypes(APowMathTypes node);
    void caseABooleanNotComp(ABooleanNotComp node);
    void caseANotNotComp(ANotNotComp node);
    void caseANotFromAndAndComp(ANotFromAndAndComp node);
    void caseAAndAndComp(AAndAndComp node);
    void caseAAndFromOrOrComp(AAndFromOrOrComp node);
    void caseAOrOrComp(AOrOrComp node);
