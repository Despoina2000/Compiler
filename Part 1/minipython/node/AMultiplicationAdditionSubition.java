...
public final class AMultiplicationAdditionSubition extends PAdditionSubition
{
    private PMultiplication _multiplication_;

    public AMultiplicationAdditionSubition()
    {
    }
    ...
    public Object clone()
    {
        return new AMultiplicationAdditionSubition(
            (PMultiplication) cloneNode(_multiplication_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMultiplicationAdditionSubition(this);
    }
