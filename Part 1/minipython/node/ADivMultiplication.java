...
public final class ADivMultiplication extends PMultiplication
{
    private PMultiplication _multiplication_;
    private TDiv _div_;
    private PPower _power_;

    public ADivMultiplication()
    {
    }
    ...
    {
        ((Analysis) sw).caseADivMultiplication(this);
    }
