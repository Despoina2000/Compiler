...
public final class AMultMultiplication extends PMultiplication
{
    private PMultiplication _multiplication_;
    private TMult _mult_;
    private PPower _power_;

    public AMultMultiplication()
    {
    }
    ...
    public Object clone()
    {
        return new AMultMultiplication(
    ...
    {
        ((Analysis) sw).caseAMultMultiplication(this);
    }
